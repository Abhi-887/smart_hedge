...
/**
 * StoreBrokerAccountRequest
 *
 * Handles validation for creating new broker accounts.
 * Ensures data integrity and security for sensitive API credentials.
 */
class StoreBrokerAccountRequest extends FormRequest
{
    /**
